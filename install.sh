...
function do_install {
    ...
    install_packages base-devel fzf git ripgrep ttf-fira-code vim gnome-shell-extension-appindicator catatonit ruff yamllint bat bat-extras pgcli exa git-delta
